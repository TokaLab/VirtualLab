            ...
            %%%%%%%%%%%% DTT-like Configuration %%%%%%%%%%%%%%%%%%%%%%%%%%%%
             ...
             case "DTT-like"
                ...
                if configuration == 1
                    ...
                    % 4 Vertical lines
                    R_in = [1.55; 1.9; 2.3; 2.8];
                    R_out = [1.55; 1.9; 2.3; 2.8];
                    Z_in = [1.75; 1.75; 1.75; 1.75];
                    Z_out = [-1.75; -1.75; -1.75; -1.75];

                    % 4 Horizontal lines
                    R_in = [R_in; 3.5; 3.5; 3.5; 3.5];
                    R_out = [R_out; 1.3; 1.3; 1.3; 1.3];
                    Z_in = [Z_in; 0; 0; 0; 0];
                    Z_out = [Z_out; -1; -0.3; 0.3; 1];
                ...
                case "TCV-like"
                    ...
                    if configuration == 1
                        ...
                        % 4 Vertical lines
                        R_in = [0.68; 0.8; 0.85; 0.9];
                        R_out = [0.68; 0.8; 0.85; 0.9];
                        Z_in = [0.8; 0.8; 0.8; 0.8];
                        Z_out = [-0.8; -0.8; -0.8; -0.8];

                        % 4 Horizontal lines
                        R_in = [R_in; 1.2; 1.2; 1.2; 1.2];
                        R_out = [R_out; 0.5; 0.5; 0.5; 0.5];
                        Z_in = [Z_in; 0; 0; 0; 0];
                        Z_out = [Z_out; -0.6; -0.2; 0.2; 0.6];
