...
figura.config.psi_lines = [0.5 0.66 0.7 0.75 0.9 0.95 1 1.1];
figura.config.subplot = [1 1 1];
figura.config.plot_wall = 1;
% figura.config.hold = "on";
figura.fig = figure();

figura = TP.PlotField(equi,"ne", figura.fig, figura.config);

figura2.config.psi_lines = [0.5 0.66 0.7 0.75 0.9 0.95 1 1.1];
figura2.config.subplot = [1 1 1];
figura2.config.plot_wall = 1;
% figura.config.hold = "on";
figura2.fig = figure();

figura2 = TP.PlotField(equi,"psi", figura2.fig, figura2.config);
